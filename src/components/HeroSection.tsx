  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#1A1F2C]">
      ...
      <div className="relative container mx-auto px-6 h-full flex items-center">
        <div className="backdrop-blur-md bg-white/10 rounded-2xl p-8 md:p-12 w-full max-w-3xl mx-auto transform transition-all duration-700 ease-out shadow-2xl border border-white/20"
             style={{
          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <h2 className="text-xl md:text-2xl text-gray-200 mb-6 animate-fade-in delay-200">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start animate-fade-in delay-400">
              <button
